package sprint_5_Exceptions.task_1;

/**
 * Create a method for calculating an area of a rectangle
 * int squareRectangle(int a, int b), which should throw
 * an IllegalArgumentException if at least one of its arguments is non positive.
 *
